...
export const menuItems: MenuItems = {
  ...
  offerings: [
    { href: "/solutions/cms", title: "Product (CMS)", description: "EV Charging Management Software based on OCPP 1.6 / 2.0.1 / 2.1.", imageUrl: "/images/solutions/solution-cms.png", imageAlt: "Product overview dashboard" },
